...
export function Tile ({ num }: { num: number }) {
  ...
  return (
    <div onClick={clickHandler} className={clsx("size-20", "grid", "place-content-center", "rounded-sm", "select-none", "font-barrio", "font-bold", "text-3xl", "text-blue-50", [ isInPlace && "bg-emerald-500", !isInPlace && "bg-rose-500" ])}>
